...
import { applicationRecords, auditSource, candidateProfile, integrations, latestRun, permanentExclusion, runRecords, scheduleBoundary } from "./workflowData";
...
export const appRouter = router({
  ...
  workflow: router({
    dashboard: protectedProcedure.query(async ({ ctx }) => ({
      ...
      schedule: { timeOne: "09:00 IST", timeTwo: "17:00 IST", expiry: "13 Oct 2026", status: "active", lastRun: latestRun, nextRun: "09:00 IST / 17:00 IST daily", ...scheduleBoundary },
    })),
